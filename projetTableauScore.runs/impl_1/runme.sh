...
HD_PWD='C:/Users/mapam/Documents/Polytech/ETN/S8/SOPC/projetTableauScorev3/projetTableauScore/projetTableauScore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chronoscore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chronoscore.tcl -notrace
